...
/**
 * Wrapper for PIXI.MeshRope
 */
export class SimpleRope extends PIXI.MeshRope implements GameObject {
	...
	constructor(name = '', texture: PIXI.Texture, points: PIXI.Point[], textureScale?: number) {
