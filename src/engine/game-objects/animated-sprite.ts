 ...
 */
export class AnimatedSprite extends PIXI.AnimatedSprite implements GameObject {
	...
	constructor(name = '', textures: PIXI.Texture[] | { texture: PIXI.Texture; time: number }[], autoUpdate?: boolean) {
