import type { Keys } from './key-input-component';
 ...
 */
export type GamepadKeyMapper = {
	KEY_UP?: typeof Keys[keyof typeof Keys];
	KEY_DOWN?: typeof Keys[keyof typeof Keys];
	KEY_LEFT?: typeof Keys[keyof typeof Keys];
	KEY_RIGHT?: typeof Keys[keyof typeof Keys];
	KEY_A?: typeof Keys[keyof typeof Keys];
	KEY_B?: typeof Keys[keyof typeof Keys];
	KEY_X?: typeof Keys[keyof typeof Keys];
	KEY_Y?: typeof Keys[keyof typeof Keys];
}
/**
...
export class VirtualGamepadComponent extends KeyInputComponent {
	...
	private gamePadRenderer: Graphics | null = null;
	...
	renderButtons() {
		...
		if (!this.buttons) {
			...
			const buttonHitSize = buttonSize * 1.3;
			this.buttonHitRects = [
		...
		if(this.gamePadRenderer) {
			...
			this.gamePadRenderer.beginFill(0xAAAAAA, this.keyMapper.KEY_UP && this.keys.has(this.keyMapper.KEY_UP) ? 0.8 : 0.5);
			this.gamePadRenderer.drawRect(this.buttons[0].x, this.buttons[0].y, this.buttons[0].width, this.buttons[0].height);
			this.gamePadRenderer.beginFill(0xAAAAAA, this.keyMapper.KEY_DOWN && this.keys.has(this.keyMapper.KEY_DOWN) ? 0.8 : 0.5);
			this.gamePadRenderer.drawRect(this.buttons[1].x, this.buttons[1].y, this.buttons[1].width, this.buttons[1].height);
			this.gamePadRenderer.beginFill(0xAAAAAA, this.keyMapper.KEY_LEFT && this.keys.has(this.keyMapper.KEY_LEFT) ? 0.8 : 0.5);
			this.gamePadRenderer.drawRect(this.buttons[2].x, this.buttons[2].y, this.buttons[2].width, this.buttons[2].height);
			this.gamePadRenderer.beginFill(0xAAAAAA, this.keyMapper.KEY_RIGHT && this.keys.has(this.keyMapper.KEY_RIGHT) ? 0.8 : 0.5);
			...
			this.gamePadRenderer.beginFill(this.keyMapper.KEY_B ? 0xe9e56f : 0x444444, this.keyMapper.KEY_B && this.keys.has(this.keyMapper.KEY_B) ? 1.0 : 0.6);
			this.gamePadRenderer.drawCircle(circX2, circY - buttonSize, buttonSize / 1.8);
			this.gamePadRenderer.beginFill(this.keyMapper.KEY_Y ? 0xe96f6f : 0x444444, this.keyMapper.KEY_Y && this.keys.has(this.keyMapper.KEY_Y) ? 1.0 : 0.6);
			this.gamePadRenderer.drawCircle(circX2, circY + buttonSize, buttonSize / 1.8);
			this.gamePadRenderer.beginFill(this.keyMapper.KEY_A ? 0x6fe986 : 0x444444, this.keyMapper.KEY_A && this.keys.has(this.keyMapper.KEY_A) ? 1.0 : 0.6);
			this.gamePadRenderer.drawCircle(circX2 - buttonSize, circY, buttonSize / 1.8);
			this.gamePadRenderer.beginFill(this.keyMapper.KEY_X ? 0x6f71e9 : 0x444444, this.keyMapper.KEY_X && this.keys.has(this.keyMapper.KEY_X) ? 1.0 : 0.6);
			this.gamePadRenderer.drawCircle(circX2 + buttonSize, circY, buttonSize / 1.8);
	...
	private getPressedButton(pos: { posX: number; posY: number }): GamepadButtons | null {
	...
	private simulateKeyEvent(btn?: GamepadButtons, pressed?: boolean) {
		let key: typeof Keys[keyof typeof Keys] | null = null;
